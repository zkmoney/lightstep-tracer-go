...
type Options struct {
	...
	// will be used.
	CollectorHost string `yaml:"collector_host" usage:"host on which the collector is running"`
	// CollectorPort is the  describes the service to which span and log data will be
	// sent.  If zero, the default will be used.
	CollectorPort int `yaml:"collector_port" usage:"port on which the collector is listening"`
	// CollectorPlaintext indicates whether to use HTTP (true) or TLS/HTTPS (false, the
	// default) when sending spans to a collector.
	CollectorPlaintext bool `yaml:"collector_plaintext" usage:"whether or not to encrypt data send to the collector"`
