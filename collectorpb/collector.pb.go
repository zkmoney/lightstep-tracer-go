...
type Reference struct {
	Relationship Reference_Relationship `protobuf:"varint,1,opt,name=relationship,proto3,enum=collector.Reference_Relationship" json:"relationship,omitempty"`
...
type Span struct {
	...
	DurationMicros uint32                     `protobuf:"varint,5,opt,name=duration_micros,json=durationMicros,proto3" json:"duration_micros,omitempty"`
...
type Tracer struct {
	TracerId uint64      `protobuf:"varint,1,opt,name=tracer_id,json=tracerId,proto3" json:"tracer_id,omitempty"`
...
func (*Tracer) Descriptor() ([]byte, []int) { return fileDescriptorCollector, []int{5} }
...
type InternalMetrics struct {
	...
	DurationMicros uint32                     `protobuf:"varint,2,opt,name=duration_micros,json=durationMicros,proto3" json:"duration_micros,omitempty"`
...
type ReportRequest struct {
	...
	TimestampOffsetMicros uint32           `protobuf:"varint,5,opt,name=timestamp_offset_micros,json=timestampOffsetMicros,proto3" json:"timestamp_offset_micros,omitempty"`
...
func (m *Log) MarshalTo(data []byte) (int, error) {
	...
	var l int
	_ = l
	if m.TimestampMicros != nil {
		data[i] = 0xa
		i++
		i = encodeVarintCollector(data, i, uint64(m.TimestampMicros.Size()))
		n2, err := m.TimestampMicros.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n2
...
func (m *Tracer) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *Tracer) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.TracerId != 0 {
		data[i] = 0x8
		i++
		i = encodeVarintCollector(data, i, uint64(m.TracerId))
	}
	if len(m.Tags) > 0 {
		for _, msg := range m.Tags {
			data[i] = 0x22
...
func (m *ReportRequest) MarshalTo(data []byte) (int, error) {
	...
	if m.Tracer != nil {
		data[i] = 0xa
		i++
		i = encodeVarintCollector(data, i, uint64(m.Tracer.Size()))
		n8, err := m.Tracer.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n8
	...
	if m.InternalData != nil {
		data[i] = 0x32
		i++
		i = encodeVarintCollector(data, i, uint64(m.InternalData.Size()))
		n10, err := m.InternalData.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *Tracer) Size() (n int) {
	var l int
	_ = l
	if m.TracerId != 0 {
		n += 1 + sovCollector(uint64(m.TracerId))
	}
	if len(m.Tags) > 0 {
		for _, e := range m.Tags {
			l = e.Size()
...
func (m *Log) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.TimestampMicros == nil {
				m.TimestampMicros = &google_protobuf.Timestamp{}
			}
			if err := m.TimestampMicros.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
	...
	for iNdEx < l {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[iNdEx]
				iNdEx++
				m.DurationMicros |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Tracer) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Tracer: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Tracer: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TracerId", wireType)
			}
			m.TracerId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := data[iNdEx]
				iNdEx++
				m.TracerId |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[iNdEx]
				iNdEx++
				m.TimestampOffsetMicros |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InternalData", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.InternalData == nil {
				m.InternalData = &InternalMetrics{}
			}
			if err := m.InternalData.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorCollector = []byte{
	...
	,
}
